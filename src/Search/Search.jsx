...
class Search extends Component {
    ...
    one = "https://api.themoviedb.org/3/movie/popular?api_key=bdd10d2b8f52bc0a5320d5c9d88bd1ff";
    two = 'https://api.themoviedb.org/3/trending/tv/day?api_key=bdd10d2b8f52bc0a5320d5c9d88bd1ff';
    state = {
        filteredData:[],
        searchTerm:'',
        searchTitle:''
    ...
    render() {
        ...
        return <Fragment>
            ...
            <div className={style.searchSection}>
                <h1 className={'text-center text-white display-1 fw-bold '+style.title}>What Are You Looking For?</h1>
                ...
                <select className={style.selectionControl+" d-inline-block"} name="" id="" onChange={(e)=>{
            ...
            <h1 className='display-2 text-white text-center'>{this.state.searchTitle}</h1>
                     <div className={"row p-5"}>
                         {this.state.filteredData.filter((val)=>{
